...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lik }\OtherTok{\textless{}{-}} \FunctionTok{Vectorize}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(alpha) }\FunctionTok{prod}\NormalTok{(}\FunctionTok{dgamma}\NormalTok{(muestraGamma}\SpecialCharTok{$}\NormalTok{x, }\AttributeTok{shape =}\NormalTok{ alpha)))}
\NormalTok{c }\OtherTok{\textless{}{-}} \FunctionTok{optimize}\NormalTok{(}\AttributeTok{f =}\NormalTok{ lik,}\AttributeTok{int =} \FunctionTok{range}\NormalTok{(muestraGamma), }\AttributeTok{maximum =} \ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{$}\NormalTok{objective}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(Resultado}\SpecialCharTok{$}\NormalTok{e, }\AttributeTok{main =} \StringTok{"Resultados de la cadena"}\NormalTok{ , }\AttributeTok{xlab =} \StringTok{"Indice de iteracion"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Estados"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
